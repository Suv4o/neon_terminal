...
👉 If you want to see the **next steps** (including how the services actually talk to each other), check out the main blog post: <NuxtLink to="/articles/2025/10/11/decoupling-a-system-with-nestjs-microservices">Decoupling a System with Nest.js Microservices</NuxtLink>.
